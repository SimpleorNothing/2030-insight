...
기획도구 생태계 표준인 **CI 편집국 컬러 트랙**을 따른다(허브 레포 `samsungda-portal`의
`STYLE_GUIDE.md` 기준). 과거에는 센싱 리포트 성격에 맞춘 Pantone 독자 팔레트를 예외적으로
썼으나, 생태계 톤 통일을 위해 CI 팔레트로 전환했다. 타이포그래피는 Pretendard.
