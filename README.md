...
경쟁사 전략 추적 보드(**CI**, `ci.samsungda.net`)의 **자체 팔레트**를 상속해 적용한다
(STYLE_GUIDE §8-2 자체 스타일 레지스트리 기준). 과거에는 Pantone Blue Fusion 독자 팔레트를
썼으나, 명시 요청으로 CI 팔레트 트랙으로 전환했다. SSOT §8-3에 따라 레이아웃·radius·타이포는
유지하고 **색 계열만** 교체했다. 타이포그래피는 Pretendard.
